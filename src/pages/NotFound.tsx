    ...
    <section className="min-h-screen flex items-center justify-center pt-[72px]">
      <div className="container-yes text-center py-20">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          <Link to="/" className="wise-btn px-7 py-3 bg-wise-green text-dark-green text-[15px] font-semibold rounded-[var(--radius-pill)]" style={{ fontFeatureSettings: '"calt"' }}>
            Back to Home
          </Link>
          <Link to="/initialize" className="wise-btn px-7 py-3 text-near-black text-[15px] font-semibold rounded-[var(--radius-pill)]" style={{ fontFeatureSettings: '"calt"', background: "var(--color-light-mint)" }}>
            Contact Us
          </Link>
        </div>
      </div>
