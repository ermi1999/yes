            ...
            {submitted ? (
              ...
              <div className="surface-card p-8 md:p-10" style={{ transform: "none" }}>
                ...
                <p className="mt-4 text-[11px] leading-relaxed text-gray/40" style={calt}>
                  By submitting, you agree to our <Link href="/privacy" className="underline">privacy policy</Link>. Your information is reviewed by our talent operations team and is never shared with third parties.
                </p>
              </div>
            )}
          </div>
